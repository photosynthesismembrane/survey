...
# Example usage
csv_file_path = 'output_images_human_evaluation_eleborate.csv'  # Specify your CSV file path here
js_file_path = 'image_data_eleborate.js'  # Specify your desired output JS file path
